...
public class s0914_EX1_연산자_1 {
	public static void main(String[] args) {
		...
		// 4. 증감
		int 정수5 = 10;
		System.out.println("후위증가 : " + (정수5++)); // 출력후 1증가
		System.out.println("확인 : " + 정수5);
		System.out.println("선위증가 : " + (++정수5)); // 출력전 1증가
		System.out.println("후위감소 : " + (정수5--)); // 출력후 1감소
		System.out.println("확인 : " + (정수5));  
		System.out.println("선위감소 : " + (--정수5)); // 출력전 1감소
