...
////////////////////////////////////////////////////////////////////////////////////////////////////
   if(input==1) {
            	      ...
            	      if( lv == 5 && 전직확인 == 0 ) {
            	  		 dm += 2;
            	  	          ...
            	  	          System.out.println("．\t 　 　 ∧ ∧ \r\n"
            	  	                ...
            	  	                + "\t　 　 　　i｜|\r\n"
            	  	                + "\t　　　　 ━━");
            	  	          System.out.println("   LV5 달성을 축하합니다 직업을 직접 입력해주세요!");
            	  	          ...
            	  	          else {System.out.println("\t제발 리스트에 있는것을 직접 입력해주세요ㅠㅠ");B_job=true;}
            	  	          }//Lv5 while E
        ...
        if(home==1) {
          ...
          if ( hunt == 1 ) {					// 1번 A던전 선택
             ...
             System.out.println("\t  ∧ ∧\r\n"
                   ...
                   + "\t /　 ⌒ヽ\r\n"
                   + "\t(人＿＿つ_つ");
             System.out.println("\t몬스터A의 정보 :"+ 몬스터_A);
     		...
     		if ( hunt_select == 1 ) {
     			...
     			boolean 변수 = true;
           		...
           		while ( true ) {
               	 ...
               	 String 몬스터_B ="몬스터B, HP:20, 획득가능 경험치 5";
                    System.out.println("\t  ∧ ∧\r\n"
                          + "\t (´･ω･)  =3\r\n"
                          + "\t /　 ⌒ヽ\r\n"
                          + "\t(人＿＿つ_つ");
                    System.out.println("\t몬스터B의 정보 : "+  몬스터B);
                    System.out.println("\t✋날잡으러 왔나");
                    System.out.println("\t사냥하시겠습니까?\n\t1. 싸우자\n\t2. 숨어있기\n\t3. 필드로 돌아가기");
            	  			...
            	  			if( battle == 1 ) {			// 1번 공격하기 선택
       						...
       						몬스터B -= dm;
         						...
         						if ( attack == 10 ) {
         							exp += 5;
         							gold++;
         							System.out.println("\t몬스터B가 처치되었습니다");
        	  						System.out.println("\t경험치 " + exp + " 획득\n골드 " + gold + " 획득");
        	  						변수 = false;
        	  						break;
         						} // if 종료
           	...
           	// =============================
            		while ( true ) {
                	 ...
                	 String 몬스터_C ="\t몬스터C, HP:20, 획득가능 경험치 5";
                     System.out.println("\t  ∧ ∧\r\n"
                           + "\t (´･ω･)  =3\r\n"
                           + "\t /　 ⌒ヽ\r\n"
                           + "\t(人＿＿つ_つ");
                     System.out.println("\t몬스터C의 정보 : " + 몬스터C);
                     System.out.println("\t✋날잡으러 왔나");
                     System.out.println("\t사냥하시겠습니까?\n\t1. 싸우자\n\t2. 숨어있기\n\t3. 필드로 돌아가기");
             			...
             			boolean 변수 = true;
             	  		while ( 변수 ) { 
             	  			...
             	  			if( battle == 1 ) {			// 1번 공격하기 선택
        						...
        						몬스터C -= dm;
          						...
          						if ( 몬스터C <= 0 ) {
          							exp += 5;
          							gold++;
          							System.out.println("\t몬스터C가 처치되었습니다");
         	  						System.out.println("\t경험치 " + exp + " 획득\n골드 " + gold + " 획득");
         	  						변수 = false;
         	  						continue;
          						} // if 종료
         	  				...
         	  				if( 전직확인==1 ) { 
        						...
        						System.out.println("\t몬스터가 가한 피해 : "+ ran);
        						System.out.println("\t내 체력 "+hp);
        						System.out.println("\t몬스터C 체력 "+몬스터C);
      ...
      /////////////////////////////////////////////////////////////마을선택/////////////////////////////////////////////////////////
               ...
               if(buy==1) {
                  System.out.println("\t👉사용골드는:"+gold--+"💪(■_■💪)\r\n"
                        + "      \t🤞맛나게 드시게나🤞");
                  }//물약구입 if E
