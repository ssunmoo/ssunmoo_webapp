...
// 전범위에서 클래스를 실행할거다
	...
	// main 메소드 작성 : 코드를 읽어주는 역할(메인 없으면 콘솔창에 출력안됨)
		...
		System.out.println(hour + "시간 " + minute + "분");
			// + 연산자
				// 1. 연결 연산자 : 변수 + "문자열" + 변수
					// 3+java => 3java
				// 2. 더하기 연산자 : 변수[숫자] + 변수[숫자] 일때		* 하나라도 문자가 있으면 연결 연산자로 됨
					// 3+3 => 6
...
/*
	...
	컴퓨터[0, 1]			본체
							1. CPU						: 관리, 감독, 제어, 번역 등
							2. 주기억장치[RAM](메모리)		: 저장[변수] : 프로그램 실행시[휘발성메모리]
							3. 보조기억장치[ROM](HHD, SSD)	: .class 코드파일[비휘발성메모리] : DB
